    ...
    return (
        <div className="app">
            ...
            <main className="app__main">
                {/* Reels component */}
                <VideoCard
                    onEnterViewport={() => console.log("1-enter")}
                    onLeaveViewport={() => console.log("1-leave")}
                ...
                />
                <VideoCard
                    onEnterViewport={() => console.log("2-enter")}
                    onLeaveViewport={() => console.log("2-leave")}
                ...
                />
                <VideoCard
                    onEnterViewport={() => console.log("3-enter")}
                    onLeaveViewport={() => console.log("3-leave")}
                    videoSrc="https://scontent-mrs2-1.cdninstagram.com/v/t50.2886-16/117598442_205338364335864_545695080903278566_n.mp4?_nc_ht=scontent-mrs2-1.cdninstagram.com&_nc_cat=100&_nc_ohc=vjDPPklLnOYAX8-HsHQ&oe=5F3A4C4F&oh=c8e095a6ee74d4548b0b81348fd06ddc"
                />
            </main>
        </div>
